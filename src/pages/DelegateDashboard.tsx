    ...
    <div className="border-b border-[var(--border)] bg-[var(--bg-elevated)] px-3 sm:px-4 py-2 sm:py-3 flex flex-wrap items-center gap-2 sm:gap-3 shadow-[0_1px_0_0_var(--border)]">
      ...
      <div className="min-w-0 flex-1">
        <Breadcrumbs
          ...
          className="mb-1"
        />
        <h1 className="page-title text-[var(--text)] truncate">📄 Delegate Dashboard</h1>
        <p className="text-xs sm:text-sm text-[var(--text-muted)] truncate">🌍 Country · 📊 Matrix · 📝 Prep · ✅ Checklist · ⏱️ Countdown</p>
      ...
      <main className="flex-1 p-2 sm:p-3 md:p-5 overflow-auto min-w-0">
        <div className="lg:hidden mb-3">
          <select
            ...
            className="w-full px-3 py-2 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border)] text-sm text-[var(--text)]"
            aria-label="Select Delegate Dashboard section"
          >
            {sections.map((s) => (
